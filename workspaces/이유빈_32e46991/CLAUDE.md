...
## [파싱 완료] 요청사항 (RSt|)
 경영학과 철학의 융합: 롤스의 정의론으로 보는 스포츠 기회의 공정한 배분 또는 경영학과 수학의 융합: 선형계획법(LP)을 활용한 스포츠 복지 예산 배분 최적화 이런 주제를 쓰고 싶어요



## [파싱 완료] 생기부 방향성 (NVS@)
플랫폼 비즈니스 모델로 설계하는 재활 스포츠 연계 서비스

사회적 임팩트 측정 방법론(SROI)을 적용한 장애인 스포츠 프로그램 평가

고령화 사회의 실버 이코노미와 스포츠·헬스케어 산업의 성장 전략

경영학과 사회복지학: 사회적 기업 모델로 구현하는 장애인 스포츠 복지 서비스

MZ세대의 가치소비 트렌드와 사회적 스포츠 기업의 브랜드 마케팅

사회보장 재정 압박과 스포츠를 통한 예방적 복지의 경제성

[노동의 가치와 인간 존엄성 성찰 — 폭염 노동자 사망 사건] ESG 경영의 노동 환경 개선

전략과 스포츠 복지 기관의 인적 자원 관리

유니버설 디자인 도입 경제적 파급 효과 분석] 장애인 친화형 스포츠 시설의 유니버설 디
자인 투자 타당성 분석과 지자체 행정 연계 방안

경영학과 사회학: 사회적 자본 이론으로 본 지역 스포츠 공동체의 경제적 가치

행동경제학의 넛지 이론을 활용한 사회적 약자의 스포츠 참여 촉진 설계

창업 생태계와 스포츠 테크(Sports Tech) 스타트업의 성장 경로 분석

소셜 미디어 마케팅과 장애인·시니어 스포츠 브랜드의 인식 제고 전략
...
## [다운로드 완료] 첨부 파일
평가기준 및 양식 (gAMl):
  - files/2026 고3 진로 수행평가1.hwpx (평가기준/양식)
수행평가 가이드 (mPfP) — 완성물/참고용, 분석 대상 아님:
  (없음)
생기부 파일:
  - files/26 이유빈 온양여고 생기부.pdf (생기부)
