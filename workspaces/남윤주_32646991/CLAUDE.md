...
## [파싱 완료] 과거 수행 과제 이력
- **통합사회1_남윤주** | 과목: 통합사회1 | 상태: 완료 | 2학기 | 마감: 2026-03-30

## [다운로드 완료] 첨부 파일
평가기준 및 양식 (gAMl):
  - files/IMG_1856.jpeg (평가기준/양식)
  - files/IMG_1857.jpeg (평가기준/양식)
  - files/IMG_1858.jpeg (평가기준/양식)
  - files/IMG_1859.jpeg (평가기준/양식)
  - files/IMG_1860.jpeg (평가기준/양식)
  - files/IMG_1861.jpeg (평가기준/양식)
수행평가 가이드 (mPfP) — 완성물/참고용, 분석 대상 아님:
  - files/비만치료제 위고비의 오남용과 미용목적 처방_남윤주.docx (완성물/참고용 — 분석 불필요)
생기부 파일:
  (없음)
