...
## [파싱 완료] 요청사항 (RSt|)
공공외교 국가브랜드 관련한 기사 최근 BTS 광화문 콘서트 등
...
## [파싱 완료] 과거 수행 과제 이력
- **공통국어1_김선아** | 과목: 공통국어1 | 상태: 완료 | 2학기 | 마감: 2026-03-30

## [다운로드 완료] 첨부 파일
평가기준 및 양식 (gAMl):
  - files/image.jpg (평가기준/양식)
  - files/image.jpg (평가기준/양식)
수행평가 가이드 (mPfP) — 완성물/참고용, 분석 대상 아님:
  - files/국가 브랜딩은 무엇이고 한류가 국가 브랜딩에 어떤 영향을 미치는가_김선아.docx (완성물/참고용 — 분석 불필요)
생기부 파일:
  (없음)
